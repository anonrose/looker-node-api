...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataActionForm', 'model/DataActionRequest', 'model/DataActionResponse', 'model/Error', 'model/ValidationError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DataActionForm'), require('../model/DataActionRequest'), require('../model/DataActionResponse'), require('../model/Error'), require('../model/ValidationError'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi31Reference) {
      root.LookerApi31Reference = {};
    }
    root.LookerApi31Reference.DataActionApi = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.DataActionForm, root.LookerApi31Reference.DataActionRequest, root.LookerApi31Reference.DataActionResponse, root.LookerApi31Reference.Error, root.LookerApi31Reference.ValidationError);
  }
}(this, function(ApiClient, DataActionForm, DataActionRequest, DataActionResponse, Error, ValidationError) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.fetchRemoteDataActionForm = function(body, callback) {
      ...
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling fetchRemoteDataActionForm");
      }
     ...
     * data is of type: {@link module:model/DataActionResponse}
     */
    this.performDataAction = function(body, callback) {
      ...
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling performDataAction");
      }
