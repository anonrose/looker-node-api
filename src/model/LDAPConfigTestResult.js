...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LDAPConfigTestIssue', 'model/LDAPUser'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LDAPConfigTestIssue'), require('./LDAPUser'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi31Reference) {
      root.LookerApi31Reference = {};
    }
    root.LookerApi31Reference.LDAPConfigTestResult = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.LDAPConfigTestIssue, root.LookerApi31Reference.LDAPUser);
  }
}(this, function(ApiClient, LDAPConfigTestIssue, LDAPUser) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('issues')) {
        obj['issues'] = ApiClient.convertToType(data['issues'], [LDAPConfigTestIssue]);
      }
   ...
   * @member {Array.<module:model/LDAPConfigTestIssue>} issues
   */
