...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.CredentialsEmail = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('forced_password_reset_at_next_login')) {
        obj['forced_password_reset_at_next_login'] = ApiClient.convertToType(data['forced_password_reset_at_next_login'], 'Boolean');
      }
   ...
   * @member {Boolean} forced_password_reset_at_next_login
   */
  exports.prototype['forced_password_reset_at_next_login'] = undefined;
  /**
