...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataActionFormField', 'model/DataActionUserState'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DataActionFormField'), require('./DataActionUserState'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi31Reference) {
      root.LookerApi31Reference = {};
    }
    root.LookerApi31Reference.DataActionForm = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.DataActionFormField, root.LookerApi31Reference.DataActionUserState);
  }
}(this, function(ApiClient, DataActionFormField, DataActionUserState) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('state')) {
        obj['state'] = DataActionUserState.constructFromObject(data['state']);
      }
  ...
  /**
   * User state
   * @member {module:model/DataActionUserState} state
   */
