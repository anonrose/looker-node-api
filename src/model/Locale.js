...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.Locale = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('english_name')) {
        obj['english_name'] = ApiClient.convertToType(data['english_name'], 'String');
      }
    }
    return obj;
  }
   ...
   */
  exports.prototype['native_name'] = undefined;
  /**
   * Name of Locale in English
   * @member {String} english_name
   */
  exports.prototype['english_name'] = undefined;
