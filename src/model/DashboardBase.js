...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LookModel', 'model/SpaceBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LookModel'), require('./SpaceBase'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi31Reference) {
      root.LookerApi31Reference = {};
    }
    root.LookerApi31Reference.DashboardBase = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.LookModel, root.LookerApi31Reference.SpaceBase);
  }
}(this, function(ApiClient, LookModel, SpaceBase) {
  'use strict';
