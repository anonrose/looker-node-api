...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.IntegrationParam = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  /**
   * The IntegrationParam model module.
   * @module model/IntegrationParam
   * @version 3.1.0
   */

  /**
   * Constructs a new <code>IntegrationParam</code>.
   * @alias module:model/IntegrationParam
   * @class
   */
  ...
  /**
   * Constructs a <code>IntegrationParam</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IntegrationParam} obj Optional instance to populate.
   * @return {module:model/IntegrationParam} The populated <code>IntegrationParam</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('user_attribute_name')) {
        obj['user_attribute_name'] = ApiClient.convertToType(data['user_attribute_name'], 'String');
      }
      if (data.hasOwnProperty('sensitive')) {
        obj['sensitive'] = ApiClient.convertToType(data['sensitive'], 'Boolean');
      }
      if (data.hasOwnProperty('per_user')) {
        obj['per_user'] = ApiClient.convertToType(data['per_user'], 'Boolean');
      }
    }
    return obj;
  }
   ...
   * @member {String} user_attribute_name
   */
  exports.prototype['user_attribute_name'] = undefined;
  /**
   ...
   * @member {Boolean} per_user
   */
  exports.prototype['per_user'] = undefined;
