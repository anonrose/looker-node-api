...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.ContentValidationDashboardFilter = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  /**
   * The ContentValidationDashboardFilter model module.
   * @module model/ContentValidationDashboardFilter
   * @version 3.1.0
   */

  /**
   * Constructs a new <code>ContentValidationDashboardFilter</code>.
   * @alias module:model/ContentValidationDashboardFilter
   * @class
   */
  ...
  /**
   * Constructs a <code>ContentValidationDashboardFilter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContentValidationDashboardFilter} obj Optional instance to populate.
   * @return {module:model/ContentValidationDashboardFilter} The populated <code>ContentValidationDashboardFilter</code> instance.
   */
