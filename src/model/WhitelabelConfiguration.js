...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.WhitelabelConfiguration = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  /**
   * The WhitelabelConfiguration model module.
   * @module model/WhitelabelConfiguration
   * @version 3.1.0
   */

  /**
   * Constructs a new <code>WhitelabelConfiguration</code>.
   * @alias module:model/WhitelabelConfiguration
   * @class
   */
  ...
  /**
   * Constructs a <code>WhitelabelConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WhitelabelConfiguration} obj Optional instance to populate.
   * @return {module:model/WhitelabelConfiguration} The populated <code>WhitelabelConfiguration</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('allow_looker_mentions')) {
        obj['allow_looker_mentions'] = ApiClient.convertToType(data['allow_looker_mentions'], 'Boolean');
      }
      if (data.hasOwnProperty('allow_looker_links')) {
        obj['allow_looker_links'] = ApiClient.convertToType(data['allow_looker_links'], 'Boolean');
      }
   ...
   * @member {Boolean} allow_looker_mentions
   */
  exports.prototype['allow_looker_mentions'] = undefined;
  /**
   * Boolean to toggle links to Looker in emails
   * @member {Boolean} allow_looker_links
   */
  exports.prototype['allow_looker_links'] = undefined;
  /**
