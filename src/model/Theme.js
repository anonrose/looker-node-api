...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ThemeSettings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ThemeSettings'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi31Reference) {
      root.LookerApi31Reference = {};
    }
    root.LookerApi31Reference.Theme = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.ThemeSettings);
  }
}(this, function(ApiClient, ThemeSettings) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('settings')) {
        obj['settings'] = ThemeSettings.constructFromObject(data['settings']);
      }
   ...
   * @member {Date} begin_at
   */
  exports.prototype['begin_at'] = undefined;
  /**
   ...
   * @member {module:model/ThemeSettings} settings
   */
