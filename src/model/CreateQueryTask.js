...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.CreateQueryTask = factory(root.LookerApi31Reference.ApiClient);
  }
   ...
   * @class
   * @param queryId {Number} Id of query to run
   * @param resultFormat {String} Desired result format
   */
  var exports = function(queryId, resultFormat) {
    var _this = this;

    _this['query_id'] = queryId;
    _this['result_format'] = resultFormat;
