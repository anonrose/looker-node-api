...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GitBranch'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GitBranch'));
  } else {
    // Browser globals (root is window)
    if (!root.LookerApi31Reference) {
      root.LookerApi31Reference = {};
    }
    root.LookerApi31Reference.ProjectWorkspace = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.GitBranch);
  }
}(this, function(ApiClient, GitBranch) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('git_branch')) {
        obj['git_branch'] = GitBranch.constructFromObject(data['git_branch']);
      }
  ...
  /**
   * GitBranch
   * @member {module:model/GitBranch} git_branch
   */
