...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.UserAttributeWithValue = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('user_attribute_id')) {
        obj['user_attribute_id'] = ApiClient.convertToType(data['user_attribute_id'], 'Number');
      }
   ...
   * @member {Number} user_attribute_id
   */
