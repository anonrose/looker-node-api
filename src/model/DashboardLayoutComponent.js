...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.DashboardLayoutComponent = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('element_title')) {
        obj['element_title'] = ApiClient.convertToType(data['element_title'], 'String');
      }
      if (data.hasOwnProperty('element_title_hidden')) {
        obj['element_title_hidden'] = ApiClient.convertToType(data['element_title_hidden'], 'Boolean');
      }
      if (data.hasOwnProperty('vis_type')) {
        obj['vis_type'] = ApiClient.convertToType(data['vis_type'], 'String');
      }
   ...
   * @member {String} element_title
   */
  exports.prototype['element_title'] = undefined;
  /**
   * Whether or not the dashboard element title is displayed.
   * @member {Boolean} element_title_hidden
   */
  exports.prototype['element_title_hidden'] = undefined;
  /**
   * Visualization type, extracted from a query's vis_config
   * @member {String} vis_type
   */
  exports.prototype['vis_type'] = undefined;
  /**
