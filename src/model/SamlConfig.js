...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Group', 'model/Role', 'model/SamlGroupRead', 'model/SamlGroupWrite', 'model/SamlUserAttributeRead', 'model/SamlUserAttributeWrite'], factory);
    ...
    root.LookerApi31Reference.SamlConfig = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.Group, root.LookerApi31Reference.Role, root.LookerApi31Reference.SamlGroupRead, root.LookerApi31Reference.SamlGroupWrite, root.LookerApi31Reference.SamlUserAttributeRead, root.LookerApi31Reference.SamlUserAttributeWrite);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('allowed_clock_drift')) {
        obj['allowed_clock_drift'] = ApiClient.convertToType(data['allowed_clock_drift'], 'Number');
      }
      ...
      if (data.hasOwnProperty('bypass_login_page')) {
        obj['bypass_login_page'] = ApiClient.convertToType(data['bypass_login_page'], 'Boolean');
      }
   ...
   * @member {Number} allowed_clock_drift
   */
  exports.prototype['allowed_clock_drift'] = undefined;
  /**
   ...
   * @member {Boolean} bypass_login_page
   */
  exports.prototype['bypass_login_page'] = undefined;
  /**
