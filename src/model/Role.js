...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelSet', 'model/PermissionSet'], factory);
    ...
    root.LookerApi31Reference.Role = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.ModelSet, root.LookerApi31Reference.PermissionSet);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('model_set_id')) {
        obj['model_set_id'] = ApiClient.convertToType(data['model_set_id'], 'Number');
      }
