...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.ContentView = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('start_of_week_date')) {
        obj['start_of_week_date'] = ApiClient.convertToType(data['start_of_week_date'], 'String');
      }
   ...
   * @member {String} start_of_week_date
   */
  exports.prototype['start_of_week_date'] = undefined;
  /**
