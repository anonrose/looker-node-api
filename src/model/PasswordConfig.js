...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.PasswordConfig = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('require_numeric')) {
        obj['require_numeric'] = ApiClient.convertToType(data['require_numeric'], 'Boolean');
      }
      if (data.hasOwnProperty('require_upperlower')) {
        obj['require_upperlower'] = ApiClient.convertToType(data['require_upperlower'], 'Boolean');
      }
      if (data.hasOwnProperty('require_special')) {
        obj['require_special'] = ApiClient.convertToType(data['require_special'], 'Boolean');
      }
   ...
   * @member {Boolean} require_numeric
   */
  exports.prototype['require_numeric'] = undefined;
  /**
   * Require at least one uppercase and one lowercase letter
   * @member {Boolean} require_upperlower
   */
  exports.prototype['require_upperlower'] = undefined;
  /**
   * Require at least one special character
   * @member {Boolean} require_special
   */
  exports.prototype['require_special'] = undefined;
  /**
