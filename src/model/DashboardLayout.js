...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DashboardLayoutComponent'], factory);
    ...
    root.LookerApi31Reference.DashboardLayout = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.DashboardLayoutComponent);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('column_width')) {
        obj['column_width'] = ApiClient.convertToType(data['column_width'], 'Number');
      }
   ...
   */
  exports.prototype['dashboard_title'] = undefined;
  /**
   * Components
