...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LookmlModelExploreField'], factory);
    ...
    root.LookerApi31Reference.LookmlModelExploreFieldset = factory(root.LookerApi31Reference.ApiClient, root.LookerApi31Reference.LookmlModelExploreField);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('parameters')) {
        obj['parameters'] = ApiClient.convertToType(data['parameters'], [LookmlModelExploreField]);
      }
    }
    return obj;
  }
  ...
  /**
   * Array of parameters
   * @member {Array.<module:model/LookmlModelExploreField>} parameters
   */
