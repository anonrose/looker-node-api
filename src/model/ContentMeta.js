...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LookerApi31Reference.ContentMeta = factory(root.LookerApi31Reference.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('inheriting_id')) {
        obj['inheriting_id'] = ApiClient.convertToType(data['inheriting_id'], 'Number');
      }
