...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.LookmlModelExploreFieldset();
  });
  ...
  describe('LookmlModelExploreFieldset', function() {
    it('should create an instance of LookmlModelExploreFieldset', function() {
      // uncomment below and update the code to test LookmlModelExploreFieldset
      //var instance = new LookerApi31Reference.LookmlModelExploreFieldset();
      //expect(instance).to.be.a(LookerApi31Reference.LookmlModelExploreFieldset);
    });
