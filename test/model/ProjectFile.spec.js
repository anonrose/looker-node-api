...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ProjectFile();
  });
  ...
  describe('ProjectFile', function() {
    it('should create an instance of ProjectFile', function() {
      ...
      //var instance = new LookerApi31Reference.ProjectFile();
      //expect(instance).to.be.a(LookerApi31Reference.ProjectFile);
    });
