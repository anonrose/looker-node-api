...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.AccessToken();
  });
  ...
  describe('AccessToken', function() {
    it('should create an instance of AccessToken', function() {
      ...
      //var instance = new LookerApi31Reference.AccessToken();
      //expect(instance).to.be.a(LookerApi31Reference.AccessToken);
    });
