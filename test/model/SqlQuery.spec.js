...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.SqlQuery();
  });
  ...
  describe('SqlQuery', function() {
    it('should create an instance of SqlQuery', function() {
      ...
      //var instance = new LookerApi31Reference.SqlQuery();
      //expect(instance).to.be.a(LookerApi31Reference.SqlQuery);
    });
    ...
    it('should have the property lastRuntime (base name: "last_runtime")', function() {
    ...
    it('should have the property browserLimit (base name: "browser_limit")', function() {
      // uncomment below and update the code to test the property browserLimit
      //var instance = new LookerApi31Reference.SqlQuery();
      //expect(instance).to.be();
    });
