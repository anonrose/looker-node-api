...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.CredentialsEmbed();
  });
  ...
  describe('CredentialsEmbed', function() {
    it('should create an instance of CredentialsEmbed', function() {
      // uncomment below and update the code to test CredentialsEmbed
      //var instance = new LookerApi31Reference.CredentialsEmbed();
      //expect(instance).to.be.a(LookerApi31Reference.CredentialsEmbed);
    });
