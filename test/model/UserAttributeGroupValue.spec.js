...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.UserAttributeGroupValue();
  });
  ...
  describe('UserAttributeGroupValue', function() {
    it('should create an instance of UserAttributeGroupValue', function() {
      // uncomment below and update the code to test UserAttributeGroupValue
      //var instance = new LookerApi31Reference.UserAttributeGroupValue();
      //expect(instance).to.be.a(LookerApi31Reference.UserAttributeGroupValue);
    });
