...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ImportedProject();
  });
  ...
  describe('ImportedProject', function() {
    it('should create an instance of ImportedProject', function() {
      // uncomment below and update the code to test ImportedProject
      //var instance = new LookerApi31Reference.ImportedProject();
      //expect(instance).to.be.a(LookerApi31Reference.ImportedProject);
    });
