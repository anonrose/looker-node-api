...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ProjectError();
  });
  ...
  describe('ProjectError', function() {
    it('should create an instance of ProjectError', function() {
      ...
      //var instance = new LookerApi31Reference.ProjectError();
      //expect(instance).to.be.a(LookerApi31Reference.ProjectError);
    });
    ...
    it('should have the property helpUrl (base name: "help_url")', function() {
    ...
    it('should have the property sanitizedMessage (base name: "sanitized_message")', function() {
      // uncomment below and update the code to test the property sanitizedMessage
      //var instance = new LookerApi31Reference.ProjectError();
      //expect(instance).to.be();
    });
