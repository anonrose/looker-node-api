...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.LookBasic();
  });
  ...
  describe('LookBasic', function() {
    it('should create an instance of LookBasic', function() {
      // uncomment below and update the code to test LookBasic
      //var instance = new LookerApi31Reference.LookBasic();
      //expect(instance).to.be.a(LookerApi31Reference.LookBasic);
    });
