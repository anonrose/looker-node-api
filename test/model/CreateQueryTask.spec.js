...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.CreateQueryTask();
  });
  ...
  describe('CreateQueryTask', function() {
    it('should create an instance of CreateQueryTask', function() {
      // uncomment below and update the code to test CreateQueryTask
      //var instance = new LookerApi31Reference.CreateQueryTask();
      //expect(instance).to.be.a(LookerApi31Reference.CreateQueryTask);
    });
