...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.LookWithQuery();
  });
  ...
  describe('LookWithQuery', function() {
    it('should create an instance of LookWithQuery', function() {
      // uncomment below and update the code to test LookWithQuery
      //var instance = new LookerApi31Reference.LookWithQuery();
      //expect(instance).to.be.a(LookerApi31Reference.LookWithQuery);
    });
