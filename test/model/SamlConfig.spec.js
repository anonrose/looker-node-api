...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.SamlConfig();
  });
  ...
  describe('SamlConfig', function() {
    it('should create an instance of SamlConfig', function() {
      // uncomment below and update the code to test SamlConfig
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be.a(LookerApi31Reference.SamlConfig);
    });
    ...
    it('should have the property idpCert (base name: "idp_cert")', function() {
      // uncomment below and update the code to test the property idpCert
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });

    it('should have the property idpUrl (base name: "idp_url")', function() {
      // uncomment below and update the code to test the property idpUrl
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });

    it('should have the property idpIssuer (base name: "idp_issuer")', function() {
      // uncomment below and update the code to test the property idpIssuer
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });

    it('should have the property idpAudience (base name: "idp_audience")', function() {
      // uncomment below and update the code to test the property idpAudience
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });

    it('should have the property allowedClockDrift (base name: "allowed_clock_drift")', function() {
      // uncomment below and update the code to test the property allowedClockDrift
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });
    ...
    it('should have the property newUserMigrationTypes (base name: "new_user_migration_types")', function() {
      // uncomment below and update the code to test the property newUserMigrationTypes
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });
    ...
    it('should have the property testSlug (base name: "test_slug")', function() {
      // uncomment below and update the code to test the property testSlug
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });
    ...
    it('should have the property groupsAttribute (base name: "groups_attribute")', function() {
      // uncomment below and update the code to test the property groupsAttribute
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });
    ...
    it('should have the property groupsMemberValue (base name: "groups_member_value")', function() {
      // uncomment below and update the code to test the property groupsMemberValue
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });

    it('should have the property bypassLoginPage (base name: "bypass_login_page")', function() {
      // uncomment below and update the code to test the property bypassLoginPage
      //var instance = new LookerApi31Reference.SamlConfig();
      //expect(instance).to.be();
    });
