...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ValidationErrorDetail();
  });
  ...
  describe('ValidationErrorDetail', function() {
    it('should create an instance of ValidationErrorDetail', function() {
      // uncomment below and update the code to test ValidationErrorDetail
      //var instance = new LookerApi31Reference.ValidationErrorDetail();
      //expect(instance).to.be.a(LookerApi31Reference.ValidationErrorDetail);
    });
