...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ContentMeta();
  });
  ...
  describe('ContentMeta', function() {
    it('should create an instance of ContentMeta', function() {
      // uncomment below and update the code to test ContentMeta
      //var instance = new LookerApi31Reference.ContentMeta();
      //expect(instance).to.be.a(LookerApi31Reference.ContentMeta);
    });
    ...
    it('should have the property inheritingId (base name: "inheriting_id")', function() {
      // uncomment below and update the code to test the property inheritingId
      //var instance = new LookerApi31Reference.ContentMeta();
      //expect(instance).to.be();
    });
