...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.DBConnectionOverride();
  });
  ...
  describe('DBConnectionOverride', function() {
    it('should create an instance of DBConnectionOverride', function() {
      // uncomment below and update the code to test DBConnectionOverride
      //var instance = new LookerApi31Reference.DBConnectionOverride();
      //expect(instance).to.be.a(LookerApi31Reference.DBConnectionOverride);
    });
