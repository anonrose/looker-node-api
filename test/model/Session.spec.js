...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.Session();
  });
  ...
  describe('Session', function() {
    it('should create an instance of Session', function() {
      ...
      //var instance = new LookerApi31Reference.Session();
      //expect(instance).to.be.a(LookerApi31Reference.Session);
    });
    ...
    it('should have the property credentialsType (base name: "credentials_type")', function() {
      // uncomment below and update the code to test the property credentialsType
      //var instance = new LookerApi31Reference.Session();
      //expect(instance).to.be();
    });

    it('should have the property extendedAt (base name: "extended_at")', function() {
      // uncomment below and update the code to test the property extendedAt
      //var instance = new LookerApi31Reference.Session();
      //expect(instance).to.be();
    });

    it('should have the property extendedCount (base name: "extended_count")', function() {
      // uncomment below and update the code to test the property extendedCount
      //var instance = new LookerApi31Reference.Session();
      //expect(instance).to.be();
    });

    it('should have the property sudoUserId (base name: "sudo_user_id")', function() {
      // uncomment below and update the code to test the property sudoUserId
      //var instance = new LookerApi31Reference.Session();
      //expect(instance).to.be();
    });
