...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.SqlQueryCreate();
  });
  ...
  describe('SqlQueryCreate', function() {
    it('should create an instance of SqlQueryCreate', function() {
      // uncomment below and update the code to test SqlQueryCreate
      //var instance = new LookerApi31Reference.SqlQueryCreate();
      //expect(instance).to.be.a(LookerApi31Reference.SqlQueryCreate);
    });
