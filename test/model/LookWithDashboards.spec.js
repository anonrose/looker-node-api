...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.LookWithDashboards();
  });
  ...
  describe('LookWithDashboards', function() {
    it('should create an instance of LookWithDashboards', function() {
      // uncomment below and update the code to test LookWithDashboards
      //var instance = new LookerApi31Reference.LookWithDashboards();
      //expect(instance).to.be.a(LookerApi31Reference.LookWithDashboards);
    });
