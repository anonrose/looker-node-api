...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.LDAPConfigTestResult();
  });
  ...
  describe('LDAPConfigTestResult', function() {
    it('should create an instance of LDAPConfigTestResult', function() {
      // uncomment below and update the code to test LDAPConfigTestResult
      //var instance = new LookerApi31Reference.LDAPConfigTestResult();
      //expect(instance).to.be.a(LookerApi31Reference.LDAPConfigTestResult);
    });
