...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.LDAPUserAttributeRead();
  });
  ...
  describe('LDAPUserAttributeRead', function() {
    it('should create an instance of LDAPUserAttributeRead', function() {
      // uncomment below and update the code to test LDAPUserAttributeRead
      //var instance = new LookerApi31Reference.LDAPUserAttributeRead();
      //expect(instance).to.be.a(LookerApi31Reference.LDAPUserAttributeRead);
    });
