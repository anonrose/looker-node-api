...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.DBConnectionTestResult();
  });
  ...
  describe('DBConnectionTestResult', function() {
    it('should create an instance of DBConnectionTestResult', function() {
      // uncomment below and update the code to test DBConnectionTestResult
      //var instance = new LookerApi31Reference.DBConnectionTestResult();
      //expect(instance).to.be.a(LookerApi31Reference.DBConnectionTestResult);
    });
