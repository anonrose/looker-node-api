...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.DBConnectionBase();
  });
  ...
  describe('DBConnectionBase', function() {
    it('should create an instance of DBConnectionBase', function() {
      // uncomment below and update the code to test DBConnectionBase
      //var instance = new LookerApi31Reference.DBConnectionBase();
      //expect(instance).to.be.a(LookerApi31Reference.DBConnectionBase);
    });
