...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.DashboardBase();
  });
  ...
  describe('DashboardBase', function() {
    it('should create an instance of DashboardBase', function() {
      // uncomment below and update the code to test DashboardBase
      //var instance = new LookerApi31Reference.DashboardBase();
      //expect(instance).to.be.a(LookerApi31Reference.DashboardBase);
    });
