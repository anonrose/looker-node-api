...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.OIDCGroupWrite();
  });
  ...
  describe('OIDCGroupWrite', function() {
    it('should create an instance of OIDCGroupWrite', function() {
      // uncomment below and update the code to test OIDCGroupWrite
      //var instance = new LookerApi31Reference.OIDCGroupWrite();
      //expect(instance).to.be.a(LookerApi31Reference.OIDCGroupWrite);
    });
