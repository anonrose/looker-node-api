...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.CreateDashboardFilter();
  });
  ...
  describe('CreateDashboardFilter', function() {
    it('should create an instance of CreateDashboardFilter', function() {
      // uncomment below and update the code to test CreateDashboardFilter
      //var instance = new LookerApi31Reference.CreateDashboardFilter();
      //expect(instance).to.be.a(LookerApi31Reference.CreateDashboardFilter);
    });
    ...
    it('should have the property explore (base name: "explore")', function() {
      // uncomment below and update the code to test the property explore
      //var instance = new LookerApi31Reference.CreateDashboardFilter();
      //expect(instance).to.be();
    });
    ...
    it('should have the property listensToFilters (base name: "listens_to_filters")', function() {
      // uncomment below and update the code to test the property listensToFilters
      //var instance = new LookerApi31Reference.CreateDashboardFilter();
      //expect(instance).to.be();
    });

    it('should have the property allowMultipleValues (base name: "allow_multiple_values")', function() {
    ...
    it('should have the property uiConfig (base name: "ui_config")', function() {
