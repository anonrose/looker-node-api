...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ContentValidationDashboardFilter();
  });
  ...
  describe('ContentValidationDashboardFilter', function() {
    it('should create an instance of ContentValidationDashboardFilter', function() {
      // uncomment below and update the code to test ContentValidationDashboardFilter
      //var instance = new LookerApi31Reference.ContentValidationDashboardFilter();
      //expect(instance).to.be.a(LookerApi31Reference.ContentValidationDashboardFilter);
    });
