...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ContentMetaGroupUser();
  });
  ...
  describe('ContentMetaGroupUser', function() {
    it('should create an instance of ContentMetaGroupUser', function() {
      // uncomment below and update the code to test ContentMetaGroupUser
      //var instance = new LookerApi31Reference.ContentMetaGroupUser();
      //expect(instance).to.be.a(LookerApi31Reference.ContentMetaGroupUser);
    });
