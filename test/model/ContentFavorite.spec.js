...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ContentFavorite();
  });
  ...
  describe('ContentFavorite', function() {
    it('should create an instance of ContentFavorite', function() {
      // uncomment below and update the code to test ContentFavorite
      //var instance = new LookerApi31Reference.ContentFavorite();
      //expect(instance).to.be.a(LookerApi31Reference.ContentFavorite);
    });
