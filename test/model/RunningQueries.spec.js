...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.RunningQueries();
  });
  ...
  describe('RunningQueries', function() {
    it('should create an instance of RunningQueries', function() {
      // uncomment below and update the code to test RunningQueries
      //var instance = new LookerApi31Reference.RunningQueries();
      //expect(instance).to.be.a(LookerApi31Reference.RunningQueries);
    });
    ...
    it('should have the property queryTaskId (base name: "query_task_id")', function() {
      // uncomment below and update the code to test the property queryTaskId
      //var instance = new LookerApi31Reference.RunningQueries();
      //expect(instance).to.be();
    });
