...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.ContentView();
  });
  ...
  describe('ContentView', function() {
    it('should create an instance of ContentView', function() {
      // uncomment below and update the code to test ContentView
      //var instance = new LookerApi31Reference.ContentView();
      //expect(instance).to.be.a(LookerApi31Reference.ContentView);
    });
    ...
    it('should have the property startOfWeekDate (base name: "start_of_week_date")', function() {
      // uncomment below and update the code to test the property startOfWeekDate
      //var instance = new LookerApi31Reference.ContentView();
      //expect(instance).to.be();
    });
