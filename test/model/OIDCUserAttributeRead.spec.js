...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.OIDCUserAttributeRead();
  });
  ...
  describe('OIDCUserAttributeRead', function() {
    it('should create an instance of OIDCUserAttributeRead', function() {
      // uncomment below and update the code to test OIDCUserAttributeRead
      //var instance = new LookerApi31Reference.OIDCUserAttributeRead();
      //expect(instance).to.be.a(LookerApi31Reference.OIDCUserAttributeRead);
    });
