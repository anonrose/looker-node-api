...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.SamlUserAttributeRead();
  });
  ...
  describe('SamlUserAttributeRead', function() {
    it('should create an instance of SamlUserAttributeRead', function() {
      // uncomment below and update the code to test SamlUserAttributeRead
      //var instance = new LookerApi31Reference.SamlUserAttributeRead();
      //expect(instance).to.be.a(LookerApi31Reference.SamlUserAttributeRead);
    });
