...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.HomepageSection();
  });
  ...
  describe('HomepageSection', function() {
    it('should create an instance of HomepageSection', function() {
      // uncomment below and update the code to test HomepageSection
      //var instance = new LookerApi31Reference.HomepageSection();
      //expect(instance).to.be.a(LookerApi31Reference.HomepageSection);
    });
    ...
    it('should have the property detailUrl (base name: "detail_url")', function() {
    ...
    it('should have the property homepageItems (base name: "homepage_items")', function() {
      // uncomment below and update the code to test the property homepageItems
      //var instance = new LookerApi31Reference.HomepageSection();
      //expect(instance).to.be();
    });
