...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.PasswordConfig();
  });
  ...
  describe('PasswordConfig', function() {
    it('should create an instance of PasswordConfig', function() {
      ...
      //var instance = new LookerApi31Reference.PasswordConfig();
      //expect(instance).to.be.a(LookerApi31Reference.PasswordConfig);
    });
    ...
    it('should have the property requireNumeric (base name: "require_numeric")', function() {
      // uncomment below and update the code to test the property requireNumeric
      //var instance = new LookerApi31Reference.PasswordConfig();
      //expect(instance).to.be();
    });

    it('should have the property requireUpperlower (base name: "require_upperlower")', function() {
      // uncomment below and update the code to test the property requireUpperlower
      //var instance = new LookerApi31Reference.PasswordConfig();
      //expect(instance).to.be();
    });

    it('should have the property requireSpecial (base name: "require_special")', function() {
