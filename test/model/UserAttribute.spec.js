...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.UserAttribute();
  });
  ...
  describe('UserAttribute', function() {
    it('should create an instance of UserAttribute', function() {
      // uncomment below and update the code to test UserAttribute
      //var instance = new LookerApi31Reference.UserAttribute();
      //expect(instance).to.be.a(LookerApi31Reference.UserAttribute);
    });
    ...
    it('should have the property userCanView (base name: "user_can_view")', function() {
      // uncomment below and update the code to test the property userCanView
      //var instance = new LookerApi31Reference.UserAttribute();
      //expect(instance).to.be();
    });
