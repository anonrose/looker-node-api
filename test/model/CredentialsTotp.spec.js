...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerApi31Reference.CredentialsTotp();
  });
  ...
  describe('CredentialsTotp', function() {
    it('should create an instance of CredentialsTotp', function() {
      // uncomment below and update the code to test CredentialsTotp
      //var instance = new LookerApi31Reference.CredentialsTotp();
      //expect(instance).to.be.a(LookerApi31Reference.CredentialsTotp);
    });
